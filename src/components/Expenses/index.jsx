...
const Expenses = () => {
    ...
    return(
        <div>
            ...
            <Statistics filteredPurchase={filteredPurchase} options={options} setIsOpen={setIsOpen}/>
            <div className='flex flex-col py-10'>
                <Months purchases={purchases} setFilteredPurchase={setFilteredPurchase} isOpen={isOpen} setIsOpen={setIsOpen}/>
                ...
                {filteredPurchase.length > 0 && filteredPurchase.map((purchase) => 
                    <Purchase purchase={purchase} key={purchase.id} purchases={purchases} setPurchases={setPurchases} setIsOpen={setIsOpen}/>
                )}
            </div>
        </div>
    )
